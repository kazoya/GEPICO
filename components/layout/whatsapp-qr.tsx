...
export function WhatsAppQr() {
  ...
  return (
    <div className="rounded-xl border border-gold/40 bg-background p-4 shadow-[0_0_20px_rgb(196_165_116_/_0.08)]">
      <p className="mb-0.5 text-sm font-medium">تواصل مباشر عبر واتساب</p>
