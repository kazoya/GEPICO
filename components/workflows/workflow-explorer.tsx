...
export function WorkflowExplorer() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <PageHeader
        title="رحلة الحليب إلى الجبن والجميد"
        description="مرجع للنقاش وليس وصفاً مؤكداً لعمل المزرعة اليوم. اضغط أي مرحلة لمعرفة البيانات والاختناق المحتمل وفرصة الأتمتة."
        demoLabel="مرجع يُراجع في الاكتشاف"
      />
      <HonestyNote>
