...
export function WorkflowExplorer() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <PageHeader
        title="من المادة إلى التركيب والشحنة"
        description="مرجع للنقاش وليس وصفاً مؤكداً لعمل GEPICO اليوم. اضغط أي مرحلة لمعرفة البيانات والاختناق المحتمل وفرصة الأتمتة."
