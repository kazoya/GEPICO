...
const layers = [
  ...
  { title: "العمليات", text: "مواصفة، إفراج مخبري، تشغيلات، توافر مستودع، طلبات محدّدين، حزمة تصدير." },
  { title: "التكامل", text: "لاحقاً: خطوط البثق إن وُجدت واجهة، WMS، ومحاسبة قائمة." },
  { title: "الذكاء", text: "بحث في المواصفات + اقتراحات بعد تاريخ كافٍ. لا قرار ذاتي على السعر أو الإفراج." },
];
